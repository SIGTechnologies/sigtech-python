...
class InterestRateSwap(Instrument):
    """
    Interest-Rate swap receiving fixed rate and paying IBOR rate.
    ...
    def __init__(
        ...
        api_response = env().client.instruments.otc.interest_rate_swap.create(
    ...
    @property
    def fixed_day_count(self) -> int:
        return self._get_reference_data()["fixedDayCount"]

    @property
    def float_day_count(self) -> int:
        return self._get_reference_data()["floatingDayCount"]

    @property
    def fixed_frequency(self) -> str:
        return self._get_reference_data()["fixedFrequency"]

    @property
    def floating_frequency(self) -> str:
        return self._get_reference_data()["floatingFrequency"]
